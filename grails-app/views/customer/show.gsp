...
<html>
    ...
    <body>
        <div id="show-customer" class="content scaffold-show" role="main">
            ...
            <g:render template="view" bean="${this.customer}" var="bean"/>

            <g:form resource="${this.customer}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit btn btn-primary" action="edit" resource="${this.customer}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
